...
2. The second example is for a link to [Thesaurus](https://www.thesaurus.com/browse/) with an input-able word to search for: 'https<break_link>://www.thesaurus.com/browse/\{Word to search for\\}'.<br>
The '\\{Word to search for\\}' section will prompt the text 'Word to search for: ' on every link open, and will concatanate the response to the end of 'https<break_link>://www.thesaurus.com/browse/'. Therefore, the user can search for words on [Thesaurus](https://www.thesaurus.com/browse/) directly from the program. <br>
