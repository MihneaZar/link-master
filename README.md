...
2. The second example is for a link to [Thesaurus](https://www.thesaurus.com/browse/) with an input-able word to search for: <div style="display: inline">'https://www.thesaurus.com/browse/\{Word to search for\\}'</div>.<br>
The '\\{Word to search for\\}' section will prompt the text 'Word to search for: ' on every link open, and will concatanate the response to the end of <div style="display: inline">'https://www.thesaurus.com/browse/'</div>. Therefore, the user can search for words on [Thesaurus](https://www.thesaurus.com/browse/) directly from the program. <br>
