...
2. The second example is for a link to [Thesaurus](https://www.thesaurus.com/browse/) with an input-able word to search for: <span>'https://www.thesaurus.com/browse/\{Word to search for\\}'</span>.<br>
